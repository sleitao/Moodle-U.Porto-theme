...
<ul id="slider1">
									<li>
										<div class="welcome" style="background-image: url(/theme/image.php?theme=up&amp;image=welcome-ipad&amp;rev=483&amp;component=theme)">
										<!-- <img src="http://moodle2.up.pt/theme/image.php?theme=up&amp;image=welcomeimg&amp;rev=483&amp;component=theme" width="416" height="207"/> -->
											<h2 class="white">Bem-vindo <br />ao Moodle U.Porto</h2>
                                                                                       <h3><a href="/mod/page/view.php?id=763"><span>O sistema de gestão de aprendizagem</span><br /><span> da Universidade do Porto</span></a></h3>											
										</div>
									</li>
									<li>
                                                                                <div class="welcome" style="background-image: url(/theme/image.php?theme=up&amp;image=welcome-mobile&amp;rev=483&amp;component=theme)">
										<!--<div class="welcome" style="background-image: url(http://moodle2.up.pt/theme/image.php?theme=up&amp;image=welcome-monkey&amp;rev=483&amp;component=theme)">-->
											<h2>Bem-vindo <br />ao Moodle U.Porto</h2>
                                                                                        <h3><a href="mod/page/view.php?id=1124"><span>... com nova interface <em>mobile!</em></span></a></h3>
										</div>
									</li>
									<li>
                                                                                <div class="welcome" style="background-image: url(/theme/image.php?theme=up&amp;image=welcome&amp;rev=483&amp;component=theme)">
										<!-- <div class="welcome" style="background-image: url(http://moodle2.up.pt/theme/image.php?theme=up&amp;image=welcome-usb&amp;rev=483&amp;component=theme)">-->
                                                                 			...
                                                                 			<h2>Bem-vindo <br />ao Moodle U.Porto</h2>
											<h3><a href="http://elearning.up.pt"><span>Tudo sobre e-learning na U.Porto</span><br /><span>http://elearning.up.pt</span></a></h3>
										</div>
									</li>
								</ul>
								...
								<div class="frontbloc">
									<h4>Sobre Moodle U.Porto</h4>
										<p>O Moodle U.PORTO apresenta novas funcionalidades, novos conceitos de utilização, numa interface mais acessível e intuitiva. Mais informações sobre o <a href="/mod/page/view.php?id=763">Moodle U.Porto</a>.</p></div>
